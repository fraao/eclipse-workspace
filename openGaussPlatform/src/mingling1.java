...
/**
 * Servlet implementation class mingling1
 */
@WebServlet("/mingling1")
public class mingling1 extends HttpServlet {
            ...
            if(temp3.equals(";")) {//判断语句是否带‘;’
                ...
                try {
                	...
                	if(temp2.equals("create")||temp2.equals("CREATE")) {//创建语句
                		...
                		out.print("<script language='javascript'>alert('执行成功！已成功创建');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("insert")||temp2.equals("INSERT")) {//插入语句
                		int num=preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功插入"+num+"行');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("update")||temp2.equals("UPDATE")) {//更新数据语句
                		int num=preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功更新"+num+"行');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("truncate")||temp2.equals("TRUNCATE")) {//删除数据语句
                		preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功删除表数据');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("drop")||temp2.equals("DROP")) {//删除语句
                		preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功删除');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("alter")||temp2.equals("ALTER")) {//修改表语句
                		preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功修改');window.location.href='guanli.jsp';</script>");
                	}else if(temp2.equals("delete")||temp2.equals("DELETE")) {//删除指定数据语句
                		int num=preparedStatement.executeUpdate();
                		out.print("<script language='javascript'>alert('执行成功！已成功删除"+num+"行');window.location.href='guanli.jsp';</script>");
                        ...
                        out.print("<script language='javascript'>alert('执行成功！已成功查询');window.location.href='guanli.jsp';</script>");
                        rs.close();
                	}
                	else {
                ...
                con.close();
                	...
                	obj.insert(con, sql1);
                	out.print("<script language='javascript'>alert('"+wrong1[1]+"');window.location.href='guanli.jsp';</script>");
                }
            }else {
            	out.print("<script language='javascript'>alert(' ERROR: 句尾应该为分号！');window.location.href='guanli.jsp';</script>");
